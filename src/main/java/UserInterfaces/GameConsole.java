...
public class GameConsole {
    ...
    private static final String MENU_PROMPT_AND_CODE_TITLE = "|-----------------"+ AsciiColours.BACKGROUND_CYAN + "<MENU>" + AsciiColours.SANE + " for instruction list or settings---------------|----------USER CODE------------|\n";
    ...
    private static final String LEFT_PANEL_FILLER = "|_______________";
    private static final String ASSETS_TITLE = "|----ASSETS-----";
    private static final String ASSETS_BODY_FILLER = "|               ";
    private static final String BOTTOM_BORDER = "|_______________|________________________STAGE__________________________|_______________________________|\n";
...
//        ArrayList<String> stage = fillDummyStage(); //18 rows x 57 columns
        ...
        output.append(AsciiColours.RED + horizontalPanel("|OBJECTIVE:", objective, 72) + AsciiColours.SANE).append(CODE_TITLE_FILLER);
        output.append(MENU_PROMPT_AND_CODE_TITLE);
        output.append(AsciiColours.BLUE + horizontalPanel("|Level: ", Integer.toString(level), 16) + AsciiColours.SANE).append(stage.get(0)).append(userCode.get(0)).append("\n");
        output.append(AsciiColours.MAGENTA + horizontalPanel("|Day:   ", Integer.toString(day), 16) + AsciiColours.SANE).append(stage.get(1)).append(userCode.get(1)).append("\n");
        output.append(AsciiColours.YELLOW + horizontalPanel("|Gold:", Integer.toString(gold), 16) + AsciiColours.SANE).append(stage.get(2)).append(userCode.get(2)).append("\n");
        output.append(LEFT_PANEL_FILLER).append(stage.get(3)).append(userCode.get(3)).append("\n");
        ...
        output.append(LEFT_PANEL_FILLER).append(stage.get(5)).append(userCode.get(5)).append("\n");
